<nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded p-2" style="border-radius: 0!important;">
	<a class="navbar-brand" href="/navigard/index.php">
		<img src="/navigard/img/logo.png" alt="NavigArd" width="250" height="66">
	</a>
	<?php
	...
	?>
		...
		<div class="collapse navbar-collapse" id="navbarsExample09">
			<ul class="navbar-nav me-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="/navigard/add_house.php">
						Добавить дом
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="/navigard/add_adr_null.php">
						Шаблон
					</a>
				</li>
				<li class="nav-item">
