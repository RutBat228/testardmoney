...
global $connect;
global $usr;
$material = isset($_GET['material']) ? h($_GET['material']) : null;
$material_count = isset($_GET['material_count']) ? h($_GET['material_count']) : null;
$material_delete = isset($_GET['material_delete']) ? h($_GET['material_delete']) : null;
$name1 = isset($_GET['vid_rabot1']) ? h($_GET['vid_rabot1']) : null;
$count1 = isset($_GET['count1']) ? h($_GET['count1']) : null;
$name2 = isset($_GET['vid_rabot2']) ? h($_GET['vid_rabot2']) : null;
$count2 = isset($_GET['count2']) ? h($_GET['count2']) : null;
$name3 = isset($_GET['vid_rabot3']) ? h($_GET['vid_rabot3']) : null;
$count3 = isset($_GET['count3']) ? h($_GET['count3']) : null;
$name4 = isset($_GET['vid_rabot4']) ? h($_GET['vid_rabot4']) : null;
$count4 = isset($_GET['count4']) ? h($_GET['count4']) : null;
$mon_id = isset($_GET['mon_id']) ? h($_GET['mon_id']) : null;
$summa = isset($_GET['summa']) ? h($_GET['summa']) : null;
$kajdomu = isset($_GET['kajdomu']) ? h($_GET['kajdomu']) : null;
$other = isset($_GET['other']) ? h($_GET['other']) : null;

$technik1 = isset($_GET['technik']['0']) ? h($_GET['technik']['0']) : null;
$technik2 = isset($_GET['technik']['1']) ? h($_GET['technik']['1']) : null;
$technik3 = isset($_GET['technik']['2']) ? h($_GET['technik']['2']) : null;
$technik4 = isset($_GET['technik']['3']) ? h($_GET['technik']['3']) : null;
$technik5 = isset($_GET['technik']['4']) ? h($_GET['technik']['4']) : null;
$technik6 = isset($_GET['technik']['5']) ? h($_GET['technik']['5']) : null;
$technik7 = isset($_GET['technik']['6']) ? h($_GET['technik']['6']) : null;
$technik8 = isset($_GET['technik']['7']) ? h($_GET['technik']['7']) : null;
...
red_index("result.php?vid_id=$encodedStr&showMoneyRain=true");
